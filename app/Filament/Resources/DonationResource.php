        ...
        return $form
            ->schema([
                ...
                Forms\Components\Select::make('user_id')
                                       ...
                                       ->searchable()
                                       ->required(),
                Forms\Components\Toggle::make('remind_me')->required(),

                Forms\Components\Repeater::make('donationCategories')
                                         ->relationship()
                                         ->collapsed()
                                         ...
                                         ->columnSpanFull(),
                Forms\Components\Fieldset::make('Confirmed donations section')
                                         ->schema([
